   ...
   <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>App Version</b> 1.2.0
    </div>
    <b>Theme Version</b> 2.0 | <strong>Copyright &copy; 2014-2015 <a href="http://almsaeedstudio.com">Almsaeed Studio</a>.</strong> All rights reserved.
  </footer>
  <!-- jQuery 2.1.4 -->
    <script src="theme/plugins/jQuery/jQuery-2.1.4.min.js"></script>
    <!-- jQuery UI 1.11.2 -->
    <script src="theme/onlen/jquery-ui.min.js" type="text/javascript"></script>
    ...
    <!-- Morris.js charts -->
    <script src="theme/onlen/raphael-min.js"></script>
    ...
    <!-- daterangepicker -->
    <script src="theme/onlen/moment.min.js" type="text/javascript"></script>
